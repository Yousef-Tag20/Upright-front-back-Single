...
%testIMG=imread('E:\My_Collegue\year 4\Image_Processing\Project\Currency counter\Currency Test Cases\2. Upright front-back all-in-one none-intersect\all-back.jpg');
testIMG=imread('E:\My_Collegue\year 4\Image_Processing\Project\Currency counter\Currency Test Cases\2. Upright front-back all-in-one none-intersect\all-front-back.jpg');
%testIMG=imread('E:\My_Collegue\year 4\Image_Processing\Project\Currency counter\Currency Test Cases\3. Rotated-none-intersect\one-rotated.jpg');
% total cach variable  
totalsum=0.0;
